...
public class liste_voiture extends JFrame implements ActionListener{
	
	Container container;
    JTable table;
    JScrollPane scrollPane;
    
	public liste_voiture(String title) {
		super(title);
		container = this.getContentPane();
		container.setLayout(new BorderLayout());
		String[] entetes = {"matricule", "marque", "couleur", "date d'achat", "prix", "etat"};
