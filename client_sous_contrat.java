...
public class client_sous_contrat extends JFrame implements ActionListener{
	
	Container container;
    JTable table;
    JScrollPane scrollPane;
    
	public client_sous_contrat(String title) {
		super(title);
	...
	private Object[][] getEmployeeDetails() {
		...
		final String QUERY = "Select * from client where etat = '"+"sous_contrat"+"'";
